          ...
          <div className="related-resources-wrapper">
            <div className="related-resource">
              ...
              <div className="text-content-wrapper">
                ...
                <Link to={ process.env.PUBLIC_URL + "/pdf/Understanding_the_science_behind_Immuno-Oncology.pdf?#view=Fit&toolbar=0" } target="_blank" rel="noreferrer" className="arrow-link-pink">Download <img src={ process.env.PUBLIC_URL + "/img/icons/arrow-right.svg" } alt="Arrow Right" /></Link>
              </div>
            </div>
            ...
            <div className="related-resource">
              ...
              <div className="text-content-wrapper">
                ...
                <Link to={ process.env.PUBLIC_URL + "/pdf/Looking_deeper_into-the_science_of_Immuno-Oncology.pdf?#view=Fit&toolbar=0" } target="_blank" rel="noreferrer" className="arrow-link-pink">Download <img src={ process.env.PUBLIC_URL + "/img/icons/arrow-right.svg" } alt="Arrow Right" /></Link>
              </div>
            </div>

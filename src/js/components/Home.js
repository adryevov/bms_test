        ...
        <Container>
          <div className="homepage-card">
            ...
            <ul className="homepage-card-links">
              <li><a href="https://ourmedoq1.explorebmsvirtual.com/?utm_source=HO3&utm_medium=OurMed_Oncology" target="_blank" rel="noreferrer" className="arrow-link-pink">Our Medicines <img src={ process.env.PUBLIC_URL + "/img/icons/arrow-right.svg" } alt="Arrow Right" /></a></li>

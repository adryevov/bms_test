    ...
    <div className="hematology-our-research-wrapper"  style={{ backgroundImage: "url(/img/hematology/research/background-multiple-myeloma.jpg)" }}>
      ...
      <section className="main-area">
        <div className="main-area-wrapper">
          <div className="main-area-wrapper-inner multiple-myeloma-main-area-wrapper">
            ...
            <a href={ process.env.PUBLIC_URL + "/pdf/VV-MED-01745_AACR Celmod Interactive_040721.pdf?#view=Fit&toolbar=0" } rel="noreferrer"  target="_blank" className="cereblon-modulation-in-multiple-myeloma-wrapper link-wrapper">
            ...
            <a href={ process.env.PUBLIC_URL + "/pdf/VV-MED-01743L_AACR_2021_BCMA_Kiosk_L05_int_CF.pdf?#view=Fit&toolbar=0" } rel="noreferrer"  target="_blank" className="targeting-BCMA-in-multiple-myeloma-wrapper link-wrapper">
